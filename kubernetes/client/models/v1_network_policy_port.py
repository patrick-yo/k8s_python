...
class V1NetworkPolicyPort(object):
    ...
    def port(self):
        ...
        The port on the given protocol. This can either be a numerical or named port on a list. If this field is not provided, this matches all port names and numbers.  # noqa: E501
