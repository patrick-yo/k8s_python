...
class V1Volume(object):
    ...
    def name(self):
        ...
        Volume's name. Must be a DNS_LABEL and unique within the list. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names  # noqa: E501
